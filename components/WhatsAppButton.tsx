...
export default function WhatsAppButton() {
  const phoneNumber = "5543999179911";
  ...
  return (
    ...
    >
      ...
      {/* Pulse Animation */}
      <span className="absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75 animate-ping group-hover:opacity-0" />
    </button>
  );
}
